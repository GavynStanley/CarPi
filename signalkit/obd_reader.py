...
_WMI_MAKE = {
    "KNA": "Kia", "KNC": "Kia", "KND": "Kia", "KNH": "Kia",
    "5XY": "Kia", "5XX": "Kia",
    "KMH": "Hyundai", "KMJ": "Hyundai", "5NP": "Hyundai", "5NM": "Hyundai",
    "1G1": "Chevrolet", "1G2": "Pontiac", "1GC": "Chevrolet", "1GT": "GMC",
    "1FA": "Ford", "1FB": "Ford", "1FC": "Ford", "1FD": "Ford", "1FM": "Ford",
    "1FT": "Ford", "3FA": "Ford",
    "1N4": "Nissan", "1N6": "Nissan", "5N1": "Nissan", "JN1": "Nissan",
    "JN8": "Nissan",
    "1HD": "Harley-Davidson",
    "1HG": "Honda", "2HG": "Honda", "2HK": "Honda", "5FN": "Honda",
    "JHM": "Honda", "SHH": "Honda",
    "1J4": "Jeep", "1C4": "Chrysler/Jeep",
    ...
    "WAU": "Audi", "WUA": "Audi",
    "WVW": "Volkswagen", "WV2": "Volkswagen", "3VW": "Volkswagen",
    "YV1": "Volvo", "YV4": "Volvo",
...
# Kia model codes (VIN position 7 for Kia vehicles)
_KIA_MODELS = {
    "A": "Forte/Cerato", "B": "Soul", "C": "Optima/K5", "D": "Forte/Cerato",
    "E": "Sportage", "F": "Cadenza/K7", "G": "Niro", "H": "Sorento",
    "J": "Stinger", "K": "K900/K9", "L": "Telluride", "N": "Seltos",
    "P": "Carnival/Sedona", "R": "EV6", "S": "Forte5/Cerato5",
    "U": "Rio/Pride",
}

# Hyundai model codes (VIN position 7)
_HYUNDAI_MODELS = {
    "A": "Accent", "B": "Santa Fe", "C": "Sonata", "D": "Elantra",
    "E": "Tucson", "F": "Azera/Grandeur", "G": "Veloster",
    "H": "Genesis", "J": "Ioniq", "K": "Palisade", "L": "Santa Cruz",
    "M": "Kona", "N": "Venue",
}

# Kia engine codes (VIN position 8)
_KIA_ENGINES = {
    ...
    "C": "1.6L Turbo GDI", "D": "2.0L GDI", "E": "Electric",
...
def decode_vin(vin):
    """
    Decode a VIN into make, model, year, and engine.
    Returns a dict with available fields.
    """
    if not vin or len(vin) < 17:
        return {"vin": vin, "error": "VIN too short"}
    ...
    # WMI → Make
    wmi = vin[:3]
    result["make"] = _WMI_MAKE.get(wmi, f"Unknown ({wmi})")

    # Model year (position 10)
    year_char = vin[9]
    result["year"] = _VIN_YEAR.get(year_char, f"Unknown ({year_char})")

    # Model (position 7) — manufacturer-specific
    model_char = vin[6]
    make_lower = result["make"].lower()
    if "kia" in make_lower:
        result["model"] = _KIA_MODELS.get(model_char, f"Unknown ({model_char})")
        engine_char = vin[7]
        result["engine"] = _KIA_ENGINES.get(engine_char, f"Unknown ({engine_char})")
    elif "hyundai" in make_lower:
        result["model"] = _HYUNDAI_MODELS.get(model_char, f"Unknown ({model_char})")
        engine_char = vin[7]
        result["engine"] = _KIA_ENGINES.get(engine_char, f"Unknown ({engine_char})")
    else:
        result["model"] = None
